...
- spark-shell
```sqlite-psql
/home/long/Downloads/spark-3.1.1-bin-hadoop3.2/bin/spark-shell --master  local[2]   --packages org.apache.iceberg:iceberg-spark-runtime-3.1_2.12:0.14.0   --conf spark.sql.catalog.spark_catalog=org.apache.iceberg.spark.SparkSessionCatalog   --conf spark.sql.catalog.spark_catalog.type=hive   --conf spark.sql.catalog.local=org.apache.iceberg.spark.SparkCatalog   --conf spark.sql.catalog.local.type=hadoop   --conf spark.sql.catalog.local.warehouse=file:///home/long/IdeaProjects/evn-etl-java/iceberg/warehouse   --conf spark.sql.defaultCatalog=local   --conf spark.sql.cli.print.header=true
